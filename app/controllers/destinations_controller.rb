class DestinationsController < ApplicationController
  ...
  private
    ...
    def destination_params
      params.require(:destination).permit(:state_id, :name, :description, :latitude, :longitude, :zoom, :radius, :slug, :highlights, :things_to_do, :camping_tips, :file, :page, :lead_photo, :lead_license)
    end
end
