class CampsitesController < ApplicationController
  ...
  private
    ...
    def campsite_params
      params.require(:campsite).permit(:name, :state_abbrev, :latitude, :longitude, :elevation, :phone, :total_sites, :electric_sites, :outhouse, :showers, :dump, :page, :lead_phto, :lead_license)
    end
end
